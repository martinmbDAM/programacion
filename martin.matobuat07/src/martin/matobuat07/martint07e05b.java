 ...
 * Descripción: Programa que prueba la clase Primitiva generando 1000 boletos al
 * azar e informa de cuántos boletos hay con 3, 4, 5 y 6 aciertos.
 */
package martin.matobuat07;

public class martint07e05b {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numGenerar; i++) {
            ...
            int num_acertados = p.numAciertos(Primitiva.generaBoleto());

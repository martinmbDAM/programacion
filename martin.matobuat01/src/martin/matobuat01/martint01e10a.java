 ...
 * del programa calcula la hipotenusa manualmente, sin usar la función propia 
 * de Java.
 * Versión alternativa: martint01e10b.java (usa la función propia de Java)
 */

package martin.matobuat01;
import java.util.Scanner;

public class martint01e10a {
    ...
    public static void main(String[] args) {
        ...
        hipotenusa = Math.sqrt((double)(Math.pow(cateto1,2) + 
                     Math.pow(cateto2,2)));

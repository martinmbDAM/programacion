 ...
 * Descripción: Programa que intercambia dos variables. Esta versión no utiliza
 * ninguna variable auxiliar.
 * Versión alternativa: martint01e09a.java (con variable auxiliar).
 */

package martin.matobuat01;
import java.util.Scanner;

public class martint01e09b {
